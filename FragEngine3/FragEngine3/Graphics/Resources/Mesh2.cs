...
{
	[Obsolete("Rewritten")]
	public abstract class Mesh2 : Resource
	{
		#region Constructors

		protected Mesh2(ResourceHandle _handle, GraphicsCore _core, bool _useFullSurfaceDef) : base(_handle)
		{
		...
		protected Mesh2(string _resourceKey, Engine _engine, bool _useFullSurfaceDef) : base(_resourceKey, _engine)
		{
